...
const sections: SettingSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      f('network.changeSourceCheckAuthor', '换源校验作者', '换源时要求作者匹配。', 'boolean', 'planned'),
      f('network.changeSourceLoadInfo', '换源加载详情', '换源时加载详情信息。', 'boolean', 'planned'),
      f('network.changeSourceLoadToc', '换源加载目录', '换源时加载目录。', 'boolean', 'planned'),
